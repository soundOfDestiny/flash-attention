...
template<typename Kernel_traits, bool Is_blocked_KV, bool Is_causal, bool Is_local, bool Has_alibi, bool Is_even_MN, bool Is_even_K, bool Split, bool Append_KV, typename Params>
...
inline __device__ void compute_attn_splitkv(const Params &params) {
    ...
    flash::compute_attn_1rowblock_splitkv<Kernel_traits, Is_blocked_KV, Is_causal, Is_local, Has_alibi, Is_even_MN, Is_even_K, Split, Append_KV>(params, bidb, bidh, m_block, n_split_idx, num_n_splits);
}
